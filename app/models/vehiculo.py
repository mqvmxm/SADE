#Modelo de vehículos con su estado operativo actual 

from datetime import datetime
from sqlalchemy import CheckConstraint
from app import db 

#el estado "en ruta" se deriva automáticamente al iniciar viajes.
#"en taller" se establece al registrar una avería
